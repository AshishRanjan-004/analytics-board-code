...
const fs = require("fs");
const saveToDb = require('../utility_functions/saveToDb')
const doc = require('../utility_functions/docPerMonth')
...
router.post("/model", (req, res) => {
    ...
    doc.documentPerMonth();
    //saveToDb.saveEntitiesToDatabase(data);
